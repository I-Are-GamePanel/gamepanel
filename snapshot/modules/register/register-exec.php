		...
		else
		{
			...
			if($db->editUser($fields,$user_id))
			{
				...
				if( empty( $settings['panel_name'] ) )
					$subject = get_lang_f('subject',"I Are Gamer");
				else
					$subject = get_lang_f('subject',$settings['panel_name']);
				
				$message = "Hello,<br><br>Your I Are Gamer account has been created and you may now login</a>.<br><br>Username: " .  $users_login . "<br><br>Remember to change your password often and the first time you login.<br><br>Please do not reply to this email!<br><br>If you dont like I Are Gamer, You dont like Games<br>";
