...
function exec_ogp_module() 
{
	...
	// Currently Online
	$title[3] = "Join our Discord";
	$content[3] = "<iframe src='https://discordapp.com/widget?id=409776353274232832&theme=dark' allowtransparency='true'  height='400' frameborder='0' sandbox='allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts'></iframe>"; 
	$href[3] = ""; //"https://discord.gg/sJx2vjMwww";
	// Invoices

  
	$title[4] = 'Due Invoices';
	$content[4] ='An Invoice will be created before your server expires. Click here to view all your past and current invoices.<br>Invoices Due : '. $invoicesDue ;
