...
sub create_screen_cmd_loop
{
	...
	. "if exist _start_co.bat ( " . "\r\n"
    . "start \"Coroutine\" _start_co.bat" . "\r\n"
	. ")" . "\r\n"
...
sub run_before_start_commands
{
	...
	if ($homedir ne "" && $server_id ne ""){
		...
		{		
			...
			my $prestartcmdfile = $windows_home_path . '\prestart.bat';
			...
			system("cmd /C start \"$prestartcmdfile\"");
		}
